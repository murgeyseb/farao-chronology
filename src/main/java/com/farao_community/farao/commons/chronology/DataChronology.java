...
public interface DataChronology<T extends Object> {
     ...
     * @throws ChronologyException if data already exist in the validity interval
     */
    void storeDataAtInstant(T data, Instant instant) throws ChronologyException;
     ...
     * @throws ChronologyException if data already exist in the validity interval
     */
    void storeDataAtInstant(T data, Instant instant, Duration duration) throws ChronologyException;
     ...
     * @throws ChronologyException if data already exist in the validity interval
     */
    void storeDataAtInstant(T data, Instant instant, Period period) throws ChronologyException;
     ...
     * @throws ChronologyException if data already exist in the validity interval
     */
    void storeDataOnInterval(T data, Interval interval) throws ChronologyException;
